...
public class COrderController extends DaikenBaseController {
	...
	public KemeanResult<String> sendTemplate(@Valid @RequestBody SendTemplatePO sendTemplatePO) {
		return corderService.sendTemplate(sendTemplatePO, getLoginConsumer());
	}
}
