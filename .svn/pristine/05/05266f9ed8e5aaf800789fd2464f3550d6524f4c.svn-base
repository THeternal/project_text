...
import com.kemean.interceptor.AdminLoginInterceptor;
...
public class LoginConf extends WebMvcConfigurerAdapter {
	...
	private static final String[] CONSUMER_NOT_INTERCEPTOR = new String[] { "/api/common/mini_apps_login",
			CONSUMER_API_PREFIX + "order/get_paid_order", CONSUMER_API_PREFIX + "message/im_record",
			CONSUMER_API_PREFIX + "pay/pay_callback_wx", CONSUMER_API_PREFIX + "pay/pay_shop_recharge_callback_alipay",
			CONSUMER_API_PREFIX + "pay/pay_shop_recharge_callback_wx" };
