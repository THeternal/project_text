...
public class BMineController extends DaikenBaseController {
	...
	public KemeanResult<String> addGoods(@Valid @RequestBody GoodsPO goodsPO) {
		return bmineService.addGoods(goodsPO, getLoginBusiness(), false);
	}
	...
	public KemeanResult<String> addAccount(@Valid @RequestBody AddAccountPO addAccountPO) {
		return bmineService.addAccount(addAccountPO, getLoginBusiness());
	}
	...
	public KemeanResult<KemeanPageApiBO<List<MessageBO>>> messageList(@Valid @RequestBody MessageListPO messageListPO) {
		return new KemeanResult<KemeanPageApiBO<List<MessageBO>>>(
				commonService.messageList(messageListPO, getLoginBusiness()));
	}
	...
	public KemeanResult<String> messageDelRead(@Valid @RequestBody MessageOperatePO messageOperatePO) {
		return commonService.messageDelRead(messageOperatePO, getLoginBusiness());
	}
