...
public class AdminShopBO extends KemeanIdBO {
	...
	public String getSettledTypeStr() {
		return settledTypeStr;
	}

	public void setSettledTypeStr(String settledTypeStr) {
		this.settledTypeStr = settledTypeStr;
	}
