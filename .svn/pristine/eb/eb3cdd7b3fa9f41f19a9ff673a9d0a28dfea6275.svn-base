...
public class DaikenOrderAfterSaleDaoImpl extends DaoSupport<DaikenOrderAfterSale>
	...
	@Override
	public List<AdminChartBO> selectGoodsReturnNum(Integer shopId, String dateStart, String dateEnd, Integer limit) {
		return mapper.selectGoodsReturnNum(shopId, dateStart, dateEnd, limit);
	}

	@Override
	public Double selectOrderCompensateTotal(Integer shopId) {
		return mapper.selectOrderCompensateTotal(shopId);
	}
