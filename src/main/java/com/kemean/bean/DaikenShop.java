...
@Table(name = "daiken_shop")
public class DaikenShop extends KemeanAbstractBaseBean {

	/**
	 * 户主uid（方便融云通信）
	 */
	@Column(name = "shop_user_uid")
	 ...
	 * 所在地
	 */
	@Column(name = "business_license_location")
	...
	public Boolean getSettledType() {
		return settledType;
	}

	public void setSettledType(Boolean settledType) {
