...
@Table(name = "daiken_goods_new")
public class DaikenGoodsNew extends KemeanAbstractBaseBean {
	 ...
	 * 折扣开始时间
	 */
	@Column(name = "discount_time_begin")
	private Date discountTimeBegin;

	/**
	 * 折扣结束时间
	 */
	@Column(name = "discount_time_end")
	private Date discountTimeEnd;

	/**
	 * 48小时发货
	 */
	@Column(name = "forty_eight")
	private Boolean fortyEight;

	/**
	 * 假一赔十
	 */
	@Column(name = "fake_goods")
	...
	public void setImgsDesc(String imgsDesc) {
