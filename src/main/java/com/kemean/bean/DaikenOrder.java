...
public class DaikenOrder extends KemeanAbstractBaseBean {
	 ...
	 * 帮代卖用户id,0为店铺自卖
	 */
	@Column(name = "id_purchasing_user")
	private Integer idPurchasingUser;
	...
	public Integer getIdPurchasingUser() {
		return idPurchasingUser;
	}

	public void setIdPurchasingUser(Integer idPurchasingUser) {
		this.idPurchasingUser = idPurchasingUser;
	}
