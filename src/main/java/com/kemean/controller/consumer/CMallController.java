...
public class CMallController extends DaikenBaseController {
	...
	public KemeanResult<KemeanPageApiBO<List<NewGoodsListBO>>> newGoodsList(
		...
		return new KemeanResult<KemeanPageApiBO<List<NewGoodsListBO>>>(
				cmallService.newGoodsList(goodsListPO, getLoginConsumer()));
	}
	...
	public KemeanResult<KemeanPageApiBO<List<OldGoodsListBO>>> oldGoodsList(
		...
		return new KemeanResult<KemeanPageApiBO<List<OldGoodsListBO>>>(
				cmallService.oldGoodsList(oldGoodsListPO, getLoginConsumer()));
	}
	 ...
	 * @date 2018年6月8日
	 */
	@RequestMapping(value = "new_goods_info", method = RequestMethod.POST)
	public KemeanResult<NewGoodsInfoBO> newGoodsInfo(@Valid @RequestBody NewGoodsInfoPO newGoodsInfoPO) {
		return new KemeanResult<NewGoodsInfoBO>(cmallService.newGoodsInfo(newGoodsInfoPO, getLoginConsumer()));
	}
	 ...
	 * @date 2018年6月8日
	 */
	@RequestMapping(value = "shop_info", method = RequestMethod.POST)
	public KemeanResult<ShopInfoBO> shopInfo(@Valid @RequestBody ShopInfoPO shopInfoPO) {
		return new KemeanResult<ShopInfoBO>(cmallService.shopInfo(shopInfoPO, getLoginConsumer()));
	}
