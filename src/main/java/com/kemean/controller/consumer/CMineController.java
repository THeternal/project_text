...
public class CMineController extends DaikenBaseController {
	 ...
	 * @date 2018年6月7日
	 */
	@RequestMapping(value = "finance/order_settle_accounts", method = RequestMethod.POST)
	public KemeanResult<String> orderSettleAccounts(@Valid @RequestBody OrderSettleAccountsPO orderSettleAccountsPO) {
		return commonService.orderSettleAccounts(orderSettleAccountsPO, getLoginConsumer());
	}
	 ...
	 * @date 2018年9月18日
	 */
	@RequestMapping(value = "finance/clear_order_list", method = RequestMethod.POST)
	public KemeanResult<KemeanPageApiBO<List<ClearOrderListBO>>> clearOrderList(
			@Valid @RequestBody ClearOrderListPO clearOrderListPO) {
		return new KemeanResult<KemeanPageApiBO<List<ClearOrderListBO>>>(
				commonService.clearOrderList(clearOrderListPO, getLoginConsumer()));
	}
	...
	public KemeanResult<KemeanPageApiBO<List<MessageBO>>> messageList(
			@Valid @RequestBody KemeanPageApiPO kemeanPageApiPO) {
		return new KemeanResult<KemeanPageApiBO<List<MessageBO>>>(
				commonService.messageList(kemeanPageApiPO, getLoginConsumer()));
	}
	 ...
	 * @date 2018年7月14日
	 */
	@RequestMapping(value = "message_del_read", method = RequestMethod.POST)
	public KemeanResult<String> messageDelRead(@Valid @RequestBody MessageOperatePO messageOperatePO) {
		return commonService.messageDelRead(messageOperatePO, getLoginConsumer());
	}
	 ...
	 * @date 2018年7月23日
	 */
	@RequestMapping(value = "im_conversation", method = RequestMethod.GET)
	public KemeanResult<List<ImRecordRedis>> imConversation() {
		return commonService.imConversation(getLoginConsumer());
	}
