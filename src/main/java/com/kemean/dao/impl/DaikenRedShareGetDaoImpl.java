...
public class DaikenRedShareGetDaoImpl extends DaoSupport<DaikenRedShareGet> implements DaikenRedShareGetDao {
	...
	@Override
	public List<AdminChartBO> selectRedShareGetRecord(Integer goodsId, List<Integer> shopId, String dateStart,
			String dateEnd, Integer limit) {
		return mapper.selectRedShareGetRecord(goodsId, shopId, dateStart, dateEnd, limit);
	}
}
