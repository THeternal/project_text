...
public class VoteInfoBO extends KemeanIdBO {
	 ...
	 * 选手信息
	 */
	private List<VoteInfoPlyearBO> voteInfoPlyearList;
	...
	public List<VoteInfoPlyearBO> getVoteInfoPlyearList() {
		return voteInfoPlyearList;
	}

	public void setVoteInfoPlyearList(List<VoteInfoPlyearBO> voteInfoPlyearList) {
		this.voteInfoPlyearList = voteInfoPlyearList;
	}
